...
X_train = X_train.reshape(X_train.shape[0], 28*28).astype('float32') / 255  # (60000,28,28,1)
X_test = X_test.reshape(X_test.shape[0], 28*28).astype('float32') / 255  # (10000,28,28,1)
print("X_train.shape :", X_train.shape)  # (60000,784)
print("X_test.shape :", X_test.shape)  # (60000,784)
'''
분류 : classification
