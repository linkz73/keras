...
y2_train, y2_test = train_test_split(y2, shuffle=False, random_state=3, test_size=0.4)
y2_val, y2_test = train_test_split(y2_test, shuffle=False, random_state=3, test_size=0.5)
