...
print(f"y1_train:{y1_train.shape}, y1_test:{y1_test.sahape}, y1_val:{y1_val.sahape}")
print(f"y2_train:{y2_train.shape}, y2_test:{y2_test.sahape}, y2_val:{y2_val.sahape}")
print(f"y3_train:{y3_train.shape}, y3_test:{y3_test.sahape}, y3_val:{y3_val.sahape}")
