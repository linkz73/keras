...
model.add(Dropout(0.2))  # 위의 레이어 노드 중 20%를 안씀. 과적합을 피하기 위함.
model.add(Dense(1000))
model.add(Dropout(0.3))  # 위의 레이어 노드 중 20%를 안씀. 과적합을 피하기 위함.
model.add(Dense(1000))
model.add(Dropout(0.4))  # 위의 레이어 노드 중 20%를 안씀. 과적합을 피하기 위함.
model.add(Dense(1000))
model.add(Dropout(0.5))  # 위의 레이어 노드 중 20%를 안씀. 과적합을 피하기 위함.
model.add(Dense(1000))
model.add(Dropout(0.5))  # 위의 레이어 노드 중 20%를 안씀. 과적합을 피하기 위함.
model.add(Dense(1000))
model.add(Dense(1))
